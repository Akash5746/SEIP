-- =====================================================================
-- SEIP Database Initialization Script
-- Runs automatically when the postgres container starts for the first
-- time (mounted at /docker-entrypoint-initdb.d/init.sql).
-- =====================================================================
...
CREATE TABLE IF NOT EXISTS expense.expenses (
    ...
    category_id BIGINT REFERENCES expense.expense_categories(id),
...
CREATE TABLE IF NOT EXISTS expense.expense_items (
    id BIGSERIAL PRIMARY KEY,
    expense_id BIGINT NOT NULL REFERENCES expense.expenses(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_expense_items_expense_id ON expense.expense_items(expense_id);
...
CREATE INDEX IF NOT EXISTS idx_receipts_expense_id ON expense.receipts(expense_id);
